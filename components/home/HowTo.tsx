              ...
              <a href="#" className="text-decoration-none">
                <Row>
                  <Col md="12" className="py-3 px-0">
                    ...
                    <div className={`text-center ${styles.pTypeText}`} key={``}>
                    ...
                    <div
                      ...
                      key={``}
                    >
                      Our real estate agents will help you find the property
                ...
                <Row>
                  <Col className="py-3 px-0 ">
                    ...
                    <div
                      ...
                      key={``}
                    >
                      Use a quick search to locate the most suitable real estate
                      option among all property ads.
                    </div>
                  </Col>
                </Row>
              </a>
                ...
                <Row>
                  <Col className="py-3 px-0 ">
                    ...
                    <div
                      ...
                      key={``}
                    >
                      Our experts will prepare the needed contracts. You just
                      sign them to seal the deal.
                    </div>
                  </Col>
                </Row>
              </a>
                ...
                <Row>
                  <Col className="py-3 px-0 ">
                    ...
                    <div
                      ...
                      key={``}
                    >
                      Let’s get connected. Reach out to our real estate agents
