  ...
  return (
    <>
      <Row className="py-1 px-1 mt-3">
        <Col md="5" className="mt-1 mb-1" key={Number(_.random(101,110).toString())}>
        ...
        <Col md="7" className="border-bottom" key={Number(_.random(111,120).toString())}>
          <Card className="border-0">
            <Row className="py-2 px-1">
              <Col className="mt-2 mb-3" key={Number(_.random(121,129).toString())}>
                <div className="mt-2 mb-1 text-color-a3a fw-bold">
                  <Row>
                    <Col className="text-start ft-20" key={Number(_.random(130,139).toString())}>{property.name}</Col>
                    <Col className="text-end" key={Number(_.random(140,149).toString())}>
